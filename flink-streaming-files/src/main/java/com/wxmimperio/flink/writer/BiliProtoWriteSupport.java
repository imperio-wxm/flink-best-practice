 ...
 */
public class BiliProtoWriteSupport<T extends MessageOrBuilder> extends WriteSupport<byte[]> {

    private static final Logger LOG = LoggerFactory.getLogger(BiliProtoWriteSupport.class);
    ...
    public BiliProtoWriteSupport(Class<? extends Message> protobufClass) {
    ...
    public WriteContext init(Configuration configuration) {
        ...
        // need enable LIST and MAP wrappers for collections
        setWriteSpecsCompliant(configuration, true);
    ...
    class FieldWriter {
        ...
        void writeField(Object value) {
            if (!(this instanceof BiliProtoWriteSupport.MapWriter)) {
